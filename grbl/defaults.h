...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_Z_STEPS_PER_MM (MICROSTEPS_Z*STEP_REVS_Z/MM_PER_REV_Z)
    ...
    #define MICROSTEPS_X            CONFIG_MICRO_X
    #define STEP_REVS_X             CONFIG_MOTOR_STEPS_X
    #define MM_PER_REV_X            (CONFIG_SCREW_LEAD_X * CONFIG_MOTOR_PULLEY_X / CONFIG_SCREW_PULLEY_X)
    #define DEFAULT_X_STEPS_PER_MM  (MICROSTEPS_X * STEP_REVS_X / MM_PER_REV_X)
    #define MICROSTEPS_Y            CONFIG_MICRO_Y
    #define STEP_REVS_Y             CONFIG_MOTOR_STEPS_Y
    #define MM_PER_REV_Y            (CONFIG_SCREW_LEAD_Y * CONFIG_MOTOR_PULLEY_Y / CONFIG_SCREW_PULLEY_Y)
    #define DEFAULT_Y_STEPS_PER_MM  (MICROSTEPS_Y * STEP_REVS_Y / MM_PER_REV_Y)
    #define MICROSTEPS_Z            CONFIG_MICRO_Z
    #define STEP_REVS_Z             CONFIG_MOTOR_STEPS_Z
    #define MM_PER_REV_Z            (CONFIG_SCREW_LEAD_Z * CONFIG_MOTOR_PULLEY_Z / CONFIG_SCREW_PULLEY_Z)
    #define DEFAULT_Z_STEPS_PER_MM  (MICROSTEPS_Z * STEP_REVS_Z / MM_PER_REV_Z)
  #endif
